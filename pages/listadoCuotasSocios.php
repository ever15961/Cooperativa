    ...
    <div class="container-fluid ">
       ...
       <div class="row p-4">
           ...
           <div class="row col-10">
                <!--<input type="text"  class="col-3 form-control" id="cuota" placeholder="Seleccione préstamo" list="codigoPrestamos">-->
                <select name="" id="cuota" class="col-6">
                    <option value="0">Seleccione préstamo</option>
                    <?php foreach($listado as $item){
                        echo "<option value=".$item[0].">Préstamo por $".number_format($item[1],2,".",",")." para Destino ".$item[2]." con Fecha ".$item[3]."</option>";
                    }?>
                </select>

                <button class="btn col-1 ml-3 bg-primary text-light" id="buscarcuota" >
                    Buscar
                </button>

                <button class="col-1 btn ml-3 bg-secondary text-light" id="limpiarBusqueda" >
                Limpiar
                </button>
           </div>
           ...
           <div class="col-2 p-0"> 
                ...
                <div class="col-10 float-right">
                    <select class="form-control col-12" disabled id="tipoCuota">
...
<script src="../js/cuota/cuotaScriptSocio.js"></script>
