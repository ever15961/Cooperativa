...
?>
    ...
    <div class="container-fluid p-4 ">
       ...
       <div class="row">
            ...
            <input type="text"  class="col-2" id="cuota" placeholder="Dato de cuota...">
        ...
        <table id="listadoCuotas" class="table table-striped mt-3 " style="width:100%">
            <thead>
                <tr>
                    <th>N°</th>
                    <th>Numero</th>
            ...
            <tbody>
                ...
                foreach ($lista as $item) {
                    echo "<tr>
                                ...
                                <td>" . $item[1] . "</td>
                                <td>" . $item[2] . "</td>
                                <td>" . ($item[3]=="1" ? 'ACTIVO' : ''), ($item[3]=="2" ? 'INACTIVO' : '') . "</td> 
                                <td> 
                                    <div class='dropdown'>
                                        ...
                                        <div class='dropdown-menu'>
                                            ...
                                            <a class='dropdown-item mostra' data-toggle='modal' data-target='#modalMostrarPrestamo'>Mostrar</a>
                                        </div>
                                    </div>
                                </td>";
...
<?php include "modal/modalRegistroCuota.php"?>
