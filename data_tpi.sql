...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2023 a las 01:30:57
...
(245, 28, 18, 191.22340240141497, '2028-03-09 06:00:00', 1, 14.375750931290035, 176.84765147012493, 398.18238578147657),
(246, 28, 19, 191.22340240141497, '2028-06-09 06:00:00', 1, 9.954559644536914, 181.26884275687806, 216.9135430245985),
(247, 28, 20, 191.22340240141497, '2028-09-09 06:00:00', 1, 5.422838575614962, 216.9135430245985, 0),
...
CREATE TABLE `prestamo` (
  ...
  `destinoPrestamo` int(11) NOT NULL COMMENT '1-cultivo,2-personal,3-financiamiento',
...
INSERT INTO `prestamo` (`id`, `montoPrestamo`, `destinoPrestamo`, `tasaInteres`, `fechaInicio`, `estadoPrestamo`, `amortizacion`, `socio`, `plazo_anio`, `plazo_cuota`, `saldo_pendiente`) VALUES
(27, 3000, 1, 10, '2023-12-09', 1, 0, 5, 5, 2, 0),
(28, 3000, 1, 10, '2023-12-09', 1, 0, 5, 5, 2, 0),
(29, 3000, 1, 10, '2023-12-09', 1, 0, 5, 5, 3, 0),
(30, 1500, 3, 3, '2023-12-11', 1, 0, 5, 2, 3, 0),
(31, 10000, 2, 16, '2024-01-02', 1, 0, 5, 1, 1, 0);
...
--
ALTER TABLE `prestamo`
  ADD CONSTRAINT `fk_socio` FOREIGN KEY (`socio`) REFERENCES `socio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
